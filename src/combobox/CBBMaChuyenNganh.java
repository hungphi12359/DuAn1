...
public class CBBMaChuyenNganh<E> extends JComboBox<E> {
    ...
    private String labeText = "Mã Chuyên Ngành";
    private Color lineColor = new Color(0, 0, 0);
    private boolean mouseOver;

    public CBBMaChuyenNganh() {
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private CBBMaChuyenNganh combo;

        public ComboUI(CBBMaChuyenNganh combo) {
            this.combo = combo;
