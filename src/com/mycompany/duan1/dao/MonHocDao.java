...
//        List<MonHoc> list = selectById(SELECT_BY_ID_SQL, id);
    ...
    public List<MonHoc> selectBangDiem(String MaSV){
        String sql="select * from MonHoc where MaChuyenNganh in (select  MaChuyenNganh from SinhVien where MaSinhVien like ?)";
